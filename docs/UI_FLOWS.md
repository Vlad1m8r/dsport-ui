...
**Цель:** базовый экран редактирования существующего шаблона.

**Ввод пользователя:**
- Открыть экран и просмотреть имя шаблона.
- Нажать «Назад».

**Основные компоненты:**
- Заголовок и отображение имени шаблона.
- Placeholder-секция «Упражнения (скоро)».
- Кнопка «Назад» к `/templates`.
